...
class Transformer_AudioClassifier(nn.Module):
    def __init__(self, input_size, num_classes, conv_channels, conv_kernel_sizes, conv_strides, embed_size, num_heads, num_transformer_blocks, mlp_hidden_dim, dropout):
        super(Transformer_AudioClassifier, self).__init__()
...
model_2 = Transformer_AudioClassifier(input_size, num_classes, conv_channels, conv_kernel_sizes, conv_strides, embed_size, num_heads, num_transformer_blocks, mlp_hidden_dim, dropout)
